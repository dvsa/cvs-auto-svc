...
public class PutTestResultsWithoutMandatoryForCOIFWithAnnual extends TestCase {
    ...
    public static Collection<Object[]> testData(){
        return Arrays.asList(new Object[][]{
                ...
                {"$.testResult.testTypes[0].secondaryCertificateNumber"},
                {"$.testResult.testTypes[0].testNumber"},
                {"$.testResult.testTypes[0].testAnniversaryDate"},
                {"$.testResult.testTypes[0].testExpiryDate"},
                ...
                {"$.testResult.testTypes[0].numberOfSeatbeltsFitted"},
                {"$.testResult.testTypes[0].lastSeatbeltInstallationCheckDate"},
                {"$.testResult.testTypes[0].seatbeltInstallationCheckDate"},
    ...
    public PutTestResultsWithoutMandatoryForCOIFWithAnnual(String jsonPath) {
