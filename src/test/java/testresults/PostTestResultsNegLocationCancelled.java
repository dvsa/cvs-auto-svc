...
public class PostTestResultsNegLocationCancelled {
    ...
    public void testResultsMissingVertical() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "vertical", ToTypeConvertor.MISSING, TestResultsLevel.LOCATION);
    ...
    public void testResultsIntegerVertical() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "vertical", RandomStringUtils.randomNumeric(1, 9), ToTypeConvertor.INTEGER, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsRandomValueVertical() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "vertical", RandomStringUtils.randomAlphanumeric(1, 9), ToTypeConvertor.STRING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
        testResultsSteps.validatePostErrorData("vertical", "must be one of [upper, lower, null]");
    }
    ...
    public void testResultsVerticalEmpty() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "vertical", "", ToTypeConvertor.STRING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
        testResultsSteps.validatePostErrorData("vertical", "must be one of [upper, lower, null]");
    }
    ...
    public void testResultsMissingHorizontal() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "horizontal", ToTypeConvertor.MISSING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsIntegerHorizontal() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "horizontal", RandomStringUtils.randomNumeric(1, 9), ToTypeConvertor.INTEGER, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsRandomValueHorizontal() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "horizontal", RandomStringUtils.randomAlphanumeric(1, 9), ToTypeConvertor.STRING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
        testResultsSteps.validatePostErrorData("horizontal", "must be one of [inner, outer, null]");
    }
    ...
    public void testResultsHorizontalEmpty() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "horizontal", "", ToTypeConvertor.STRING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
        testResultsSteps.validatePostErrorData("horizontal", "must be one of [inner, outer, null]");
    }
    ...
    public void testResultsMissingLateral() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "lateral", ToTypeConvertor.MISSING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsMissingLongitudinal() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "longitudinal", ToTypeConvertor.MISSING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsIntegerLongitudinal() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "longitudinal", RandomStringUtils.randomNumeric(1, 9), ToTypeConvertor.INTEGER, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsRandomValueLongitudinal() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "longitudinal", RandomStringUtils.randomAlphanumeric(1, 9), ToTypeConvertor.STRING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
        testResultsSteps.validatePostErrorData("longitudinal", "must be one of [front, rear, null]");
    }
    ...
    public void testResultsLongitudinalEmpty() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "longitudinal", "", ToTypeConvertor.STRING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
        testResultsSteps.validatePostErrorData("longitudinal", "must be one of [front, rear, null]");
    }
    ...
    public void testResultsMissingRowNumber() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "rowNumber", ToTypeConvertor.MISSING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsStringRowNumber() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "rowNumber", RandomStringUtils.randomAlphanumeric(14), ToTypeConvertor.STRING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsLengthMaxRowNumber() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "rowNumber", String.valueOf(new Random().nextInt(999) + 21), ToTypeConvertor.INTEGER, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsMissingSeatNumber() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "seatNumber", ToTypeConvertor.MISSING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsStringSeatNumber() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "seatNumber", RandomStringUtils.randomAlphanumeric(14), ToTypeConvertor.STRING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsLengthMaxSeatNumber() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "seatNumber", String.valueOf(new Random().nextInt(999) + 7), ToTypeConvertor.INTEGER, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsMissingAxleNumber() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "axleNumber", ToTypeConvertor.MISSING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsStringAxleNumber() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "axleNumber", RandomStringUtils.randomAlphanumeric(14), ToTypeConvertor.STRING, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
    ...
    public void testResultsLengthMaxAxleNumber() {
        ...
        testResultsSteps.postTestResultsFieldChange(vehicleCancelledData.setVrm(VRM).build(), "axleNumber", String.valueOf(new Random().nextInt(999) + 11), ToTypeConvertor.INTEGER, TestResultsLevel.LOCATION);
        testResultsSteps.statusCodeShouldBe(400);
