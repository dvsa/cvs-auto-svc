...
public class PostTestResultsTirNegativeTrl {
    ...
    public PostTestResultsTirNegativeTrl(String testTypeId, String name, String testTypeName, String certificateNumber) {
    ...
    @Title("CVSB-3946 - API changes related to test records to enable TIR testing - negative - empty certificateNumber - TRL")
    @Test
