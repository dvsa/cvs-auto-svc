...
public class PostTestResultsRoadworthinessCertificateGeneration {
    ...
    public void updateJson(){
        ...
        test_results_roadworthiness_trl_pass_qjt1_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName,"$");
        test_results_roadworthiness_trl_pass_qjt2_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName2,"$");
        test_results_roadworthiness_trl_pass_qjt4_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName3,"$");
        test_results_roadworthiness_hgv_pass_qjv2_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName4,"$");
        test_results_roadworthiness_hgv_pass_qjv3_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName5,"$");
        test_results_roadworthiness_hgv_pass_qjv4_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName6,"$");
        test_results_roadworthiness_hgv_pass_qjv5_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName7,"$");
        test_results_roadworthiness_hgv_pass_qkv_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName8,"$");
        test_results_roadworthiness_trl_pass_qkt_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName9,"$");
        test_results_roadworthiness_hgv_pass_qpv_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName10,"$");
        test_results_roadworthiness_trl_pass_qpt_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName11,"$");
        test_results_roadworthiness_hgv_pass_qqv_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName12,"$");
        test_results_roadworthiness_trl_pass_qqt_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName13,"$");
        test_results_roadworthiness_trl_pass_rut_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName14,"$");
        test_results_roadworthiness_trl_fail_qjt1_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName15,"$");
        test_results_roadworthiness_trl_fail_qjt2_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName16,"$");
        test_results_roadworthiness_trl_fail_qjt4_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName17,"$");
        test_results_roadworthiness_hgv_fail_qjv2_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName18,"$");
        test_results_roadworthiness_hgv_fail_qjv3_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName19,"$");
        test_results_roadworthiness_hgv_fail_qjv4_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName20,"$");
        test_results_roadworthiness_hgv_fail_qjv5_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName21,"$");
        test_results_roadworthiness_hgv_fail_qkv_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName22,"$");
        test_results_roadworthiness_trl_fail_qkt_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName23,"$");
        test_results_roadworthiness_hgv_fail_qpv_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName24,"$");
        test_results_roadworthiness_trl_fail_qpt_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName25,"$");
        test_results_roadworthiness_hgv_fail_qqv_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName26,"$");
        test_results_roadworthiness_trl_fail_qqt_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName27,"$");
        test_results_roadworthiness_trl_fail_rut_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName28,"$");
        test_results_roadworthiness_hgv_fail_ruv_7677_json = GenericData.updateJson(testResultsSteps,jsonFileName29,"$");
    }
