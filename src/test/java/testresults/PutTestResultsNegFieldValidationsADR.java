...
public class PutTestResultsNegFieldValidationsADR extends TestCase {
    ...
    public PutTestResultsNegFieldValidationsADR(String jsonPath, Object value) {
        this.jsonPath = jsonPath;
        this.value = value;
    }

    @WithTag("Vtm")
    @Title("CVSB-10300 - AC1 PUT: Attempt to update a test record with a not applicable field - HGV")
    @Test
    public void testResultsPutWithNotApplicableFields() {
        ...
        JsonPathAlteration alterationModTypeUsed = new JsonPathAlteration("$.testResult.testTypes[0]","Big Filter", "modificationTypeUsed", "ADD_FIELD");
