...
public class PostTestResultsPreservationExpiryDateNegativePsv_12982 {
    ...
    public void testResultsExpiryDateWrongDateFormat() {
        ...
        JsonPathAlteration alterationInsertTestExpiryDate = new JsonPathAlteration("$.testTypes[0].testExpiryDate", "01-05-2020", "", "REPLACE");
        ...
        System.out.println("Inserted previous ExpiryDate: " + "01-05-2020");
