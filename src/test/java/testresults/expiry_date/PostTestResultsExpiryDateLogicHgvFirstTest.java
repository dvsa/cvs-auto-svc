...
@UseTestDataFrom(value="loader/testdata/test_data_expiry_date_hgv_first_test_12215.csv")
public class PostTestResultsExpiryDateLogicHgvFirstTest {
    ...
    @WithTag("expiry_dates")
    @Title("CVSB-12215 - AC4 - No registration date in vehicle's tech records (HGV) - regnDate = null")
    @Test
    public void testResultsFirstTestExpiryHgvNoRegnDateNull() {
        ...
        String testExpiryDate = submittedEndTimestamp.dayOfMonth().withMaximumValue().plusYears(1).withTimeAtStartOfDay().toInstant().toString();
    ...
    @WithTag("expiry_dates")
    @Title("CVSB-12215 - AC4 - No registration date in vehicle's tech records (HGV) - regnDate is missing")
    @Test
    public void testResultsFirstTestExpiryHgvNoRegnDateMissing() {
        ...
        String testAnniversaryDate = submittedTypeEndTimestamp.plusYears(1).dayOfMonth().withMaximumValue().withTimeAtStartOfDay().toInstant().toString();
        String testExpiryDate = submittedEndTimestamp.plusYears(1).dayOfMonth().withMaximumValue().withTimeAtStartOfDay().toInstant().toString();
    ...
    @Test
    public void testResultsFirstTestExpiryHgvTwoMonthsBeforeRegnAnniversary() {
        ...
        DateTime regnAnniversary = submittedRegnDate.dayOfMonth().withMaximumValue().plusYears(1);
        DateTime submittedEndTimestamp = currentTime;
        ...
        System.out.println("regnAnniversary: " + regnAnniversary);
...
//        System.out.println("submittedTestTypeEndTimestamp: " + testTypeEndTimestamp);
    ...
    @WithTag("expiry_dates")
    @Title("CVSB-12215 - AC2 - No previous expiry date, test date is less than (but not including) 2 months before the registration anniversary (HGV)")
    @Test
    public void testResultsFirstTestExpiryHgvLessThanTwoBeforeRegnAnniversary() {
        ...
        String testExpiryDate = regnAnniversary.plusYears(1).toInstant().toString();
