...
@UseTestDataFrom(value="loader/testdata/test_data_expiry_date_trl_first_test_12215.csv")
public class PostTestResultsExpiryDateLogicTrlFirstTest {
    ...
    @WithTag("expiry_dates")
    @Title("CVSB-12215 - AC5 - No first use date in vehicle's tech records (TRL) - firstUseDate = null")
    @Test
    public void testResultsFirstTestExpiryTrlNoFirstDateNull() {
        ...
        String testExpiryDate = submittedTypeEndTimestamp.dayOfMonth().withMaximumValue().plusYears(1).withTimeAtStartOfDay().toInstant().toString();
    ...
    @WithTag("expiry_dates")
    @Title("CVSB-12215 - AC5 - No first use date in vehicle's tech records (TRL) - firstUseDate is missing")
    @Test
    public void testResultsFirstTestExpiryTrlNoFirstDateMissing() {
        ...
        String testTypeEndTimestamp = submittedTypeEndTimestamp.toInstant().toString();
        String testEndTimestamp = submittedEndTimestamp.toInstant().toString();
        String testAnniversaryDate = submittedTypeEndTimestamp.plusYears(1).dayOfMonth().withMaximumValue().withTimeAtStartOfDay().toInstant().toString();
        String randomVin = GenericData.generateRandomVin();
        String randomSystemNo = GenericData.generateRandomSystemNumber();
        String randomTestResultId = UUID.randomUUID().toString();

        String testExpiryDate = submittedTypeEndTimestamp.plusYears(1).dayOfMonth().withMaximumValue().toInstant().toString();
        ...
        testResultsSteps.valueForFieldInPathShouldStartWith("[0].testTypes[0].testAnniversaryDate", testAnniversaryDate.substring(0,10));
    ...
    @WithTag("expiry_dates")
    @Title("CVSB-12215 - AC1 - No previous expiry date, test date 2 months or more before the registration anniversary/ first use anniversary (HGVT)")
    @Test
    public void testResultsFirstTestExpiryTrlTwoMonthsBeforeFirstAnniversary() {
        ...
        DateTime submittedFirstUseDate = currentTime.minusYears(1).plusMonths(2);;
        DateTime firstAnniversary = submittedFirstUseDate.dayOfMonth().withMaximumValue().plusYears(1);
        ...
        System.out.println("firstAnniversary: " + firstAnniversary);
...
//        System.out.println("submittedTestTypeEndTimestamp: " + testTypeEndTimestamp);
        ...
        System.out.println("returned_testAnniversaryDate: " + testExpiryDate);
        System.out.println("\n");
    ...
    @WithTag("expiry_dates")
    @Title("CVSB-12215 - AC3 - No previous expiry date, test date is less than (but not including) 2 months before the first use anniversary (TRL)")
    @Test
    public void testResultsFirstTestExpiryTrlLessThanTwoBeforeFirstAnniversary() {
        ...
        DateTime firstUseAnniversary = submittedFirstUseDate.plusYears(1).dayOfMonth().withMaximumValue();
        DateTime submittedEndTimestamp = currentTime;
        ...
        String testExpiryDate = firstUseAnniversary.plusYears(1).toInstant().toString();

        System.out.println("submittedFirstUseDate: " + firstUseDate);
        System.out.println("firstUseAnniversary: " + firstUseAnniversary);
//        System.out.println("submittedTestStartTimestamp: " + testStartTimestamp);
//        System.out.println("submittedTestTypeStartTimestamp: " + testTypeStartTimestamp);
//        System.out.println("submittedTestTypeEndTimestamp: " + testTypeEndTimestamp);
        System.out.println("submittedTestEndTimestamp: " + testEndTimestamp);
