...
@UseTestDataFrom(value="loader/testdata/test_data_expiry_date_annual_negative_hgv_12982.csv")
public class PostTestResultsPreservationExpiryDateNegativeHgv_12982 {
    ...
    public void testResultsExpiryDateWrongDateFormatHgv() {
        ...
        String insertedTestResultRecord = GenericData.readJsonValueFromFile("test-results_insert_expiry_date_negative_hgv_12982.json", "$");
        // Read the base POST test result JSON.
        String postTestResultRecord = GenericData.readJsonValueFromFile("test-results_post_expiry_date_negative_hgv_12982.json", "$");
