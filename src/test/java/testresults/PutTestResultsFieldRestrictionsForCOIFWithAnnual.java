...
public class PutTestResultsFieldRestrictionsForCOIFWithAnnual extends TestCase {
    ...
    public static Collection<Object[]> testData(){
        return Arrays.asList(new Object[][]{
                ...
                {"$.testResult.testTypes[0].secondaryCertificateNumber",999},
                {"$.testResult.testTypes[0].testAnniversaryDate","21/08/1987"},
                {"$.testResult.testTypes[0].testAnniversaryDate",false},
                {"$.testResult.testTypes[0].testExpiryDate","21/08/1987"},
                {"$.testResult.testTypes[0].testExpiryDate",false},
                ...
                {"$.testResult.testTypes[0].seatbeltInstallationCheckDate", 100},
                {"$.testResult.testTypes[0].seatbeltInstallationCheckDate","String"},
                {"$.testResult.testTypes[0].numberOfSeatbeltsFitted","String"},
                {"$.testResult.testTypes[0].lastSeatbeltInstallationCheckDate","21/08/1987"},
                {"$.testResult.testTypes[0].lastSeatbeltInstallationCheckDate",false},
    ...
    public PutTestResultsFieldRestrictionsForCOIFWithAnnual(String jsonPath, Object value) {
