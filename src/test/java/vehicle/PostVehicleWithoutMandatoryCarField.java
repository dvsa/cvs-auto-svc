...
public class PostVehicleWithoutMandatoryCarField {
    ...
    public PostVehicleWithoutMandatoryCarField(String jsonPath) {
        this.jsonPath = jsonPath;
    }

    @WithTag("Vtm")
    @Title("CVSB-10328 - AC2. POST: Attempt to create a new vehicle without a mandatory field - CAR")
    @Test
    public void testPostValidateRequestWithoutMandatoryCarField() {
        // TEST SETUP
        // generate random Vin
