...
//                {"$.techRecord[0].frontVehicleTo5thWheelCouplingMin", 100000},
//                {"$.techRecord[0].frontVehicleTo5thWheelCouplingMin", -1},
//                {"$.techRecord[0].frontVehicleTo5thWheelCouplingMin", RandomStringUtils.randomAlphabetic(5)},
//                {"$.techRecord[0].frontVehicleTo5thWheelCouplingMax", 100000},
//                {"$.techRecord[0].frontVehicleTo5thWheelCouplingMax", -1},
//                {"$.techRecord[0].frontVehicleTo5thWheelCouplingMax", RandomStringUtils.randomAlphabetic(5)},
...
//
//    public PutVehicleHgvFieldRestrictions(String jsonPath, Object value) {
//        this.jsonPath = jsonPath;
//        this.value = value;
//    }
//
//    @WithTag("Vtm")
//    @Title("CVSB-10211 - AC3 - Attempt to update a vehicle with unexpected values for a field that accepts only specific values " +
