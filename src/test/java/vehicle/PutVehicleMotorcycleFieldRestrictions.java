...
public class PutVehicleMotorcycleFieldRestrictions {
    ...
    public PutVehicleMotorcycleFieldRestrictions(String jsonPath, Object value) {
    ...
    @Title("CVSB-11814 - AC4. PUT: Attempt to update a vehicle with unexpected values for a field that accepts only specific values " +
            "AC5. PUT: Attempt to update a vehicle, using a field which has a field value outside of the min/max length for that field - MOTORCYCLE")
    @Test
    public void testPutValidateMotorcycleAttributesDataTypesAndRestrictions() {
