...
public class PutVehicleWithoutMandatoryMotorcycleField extends TestCase {
    ...
    public PutVehicleWithoutMandatoryMotorcycleField(String jsonPath) {
        this.jsonPath = jsonPath;
    }

    @WithTag("Vtm")
    @Title("CVSB-11814 - AC2. PUT: Attempt to update a vehicle without a mandatory field - MOTORCYCLE")
    @Test
    public void testValidatePutRequestWithoutMandatoryMotorcycleAttribute() {
