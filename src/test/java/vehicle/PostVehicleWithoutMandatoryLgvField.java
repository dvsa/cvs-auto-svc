...
public class PostVehicleWithoutMandatoryLgvField {
    ...
    public PostVehicleWithoutMandatoryLgvField(String jsonPath) {
        this.jsonPath = jsonPath;
    }

    @WithTag("Vtm")
    @Title("CVSB-10328 - AC2. POST: Attempt to create a new vehicle without a mandatory field - LGV")
    @Test
    public void testPostValidateRequestWithoutMandatoryLgvField() {
        // TEST SETUP
        // generate random Vin
        ...
        //create alteration to change the vehicleType to lgv
        JsonPathAlteration alterationVehicleType = new JsonPathAlteration("$.techRecord[0].vehicleType", "lgv","","REPLACE");
        // initialize the alterations list with both declared alterations
        List<JsonPathAlteration> alterations = new ArrayList<>(Arrays.asList(alterationVin, alterationVrm, alterationSystemNumber,alterationVehicleType));
