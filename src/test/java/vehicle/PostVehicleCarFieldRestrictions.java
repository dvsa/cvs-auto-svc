...
//public class PostVehicleCarFieldRestrictions {
//
...
//
//    public PostVehicleCarFieldRestrictions(String jsonPath, Object value) {
...
//            "AC5. POST: Attempt to create a new vehicle, using a field which has a field value outside of the min/max length for that field - CAR")
//    @Test
//    public void testPostValidateCarAttributesDataTypesAndRestrictions() {
//
