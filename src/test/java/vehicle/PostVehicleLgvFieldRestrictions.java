...
public class PostVehicleLgvFieldRestrictions {
    ...
    public PostVehicleLgvFieldRestrictions(String jsonPath, Object value) {
    ...
    @Title("CVSB-10328 - AC4. POST: Attempt to create a new vehicle with unexpected values for a field that accepts only specific values " +
            "AC5. POST: Attempt to create a new vehicle, using a field which has a field value outside of the min/max length for that field - LGV")
    @Test
    public void testPostValidateLgvAttributesDataTypesAndRestrictions() {
