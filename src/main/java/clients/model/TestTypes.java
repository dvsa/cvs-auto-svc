...
//    PTV4("40", "tgv4", TestTypeClassification.CERTIFICATE.getValue()),
    ...
    QKV("62", "qkv", TestTypeClassification.CERTIFICATE.getValue()),
    MDA("100", "mda", TestTypeClassification.NO_CERTIFICATE.getValue()),
    MDU("121", "mdu", TestTypeClassification.NO_CERTIFICATE.getValue()),
    QKT("101", "qkt", TestTypeClassification.CERTIFICATE.getValue()),
    QPV("62", "qpv", TestTypeClassification.CERTIFICATE.getValue()),
    QPT("62", "qpt", TestTypeClassification.CERTIFICATE.getValue()),
    QQV("62", "qqv", TestTypeClassification.CERTIFICATE.getValue()),
    QQT("62", "qqt", TestTypeClassification.CERTIFICATE.getValue()),
    RUV("63", "ruv", TestTypeClassification.CERTIFICATE.getValue()),
    RUT("63", "rut", TestTypeClassification.CERTIFICATE.getValue()),
    ...
    QJV2("122", "qjv2", TestTypeClassification.CERTIFICATE.getValue()),
    QJV3("122", "qjv3", TestTypeClassification.CERTIFICATE.getValue()),
    QJV4("122", "qjv4", TestTypeClassification.CERTIFICATE.getValue()),
    QJV5("122", "qjv5", TestTypeClassification.CERTIFICATE.getValue()),
    QJT1("91", "qjt1", TestTypeClassification.CERTIFICATE.getValue()),
    QJT2("122", "qjt2", TestTypeClassification.CERTIFICATE.getValue()),
    QJT3("122", "qjt3", TestTypeClassification.CERTIFICATE.getValue()),
    QJT4("122", "qjt4", TestTypeClassification.CERTIFICATE.getValue()),
    QJT5("122", "qjt5", TestTypeClassification.CERTIFICATE.getValue()),
