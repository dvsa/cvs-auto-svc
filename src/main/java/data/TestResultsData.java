...
public class TestResultsData {
    ...
    public static TestResults buildTestResultsSubmittedData() {
    ...
    public static TestResults buildTestResultsDataForPost() {
    ...
    public static TestResults buildTestResultsCancelledData() {
        ...
        TestTypes testTypes = new TestTypes()
                .setCreatedAt("2018-01-14T10:36:33.987Z")
                .setLastUpdatedAt("2018-01-14T10:36:33.987Z")
                .setTestCode("ASD")
                .setTestTypeName("string")
                .setTestId("string")
                .setCertificateNumber("string")
