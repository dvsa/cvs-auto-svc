...
public class WebDriverBrowsertack {
    ...
    /**
     * VSA e-mails have been pointed to gov. notify API Integration for the dev environment with VTA-83
     * Code can be re-used if e-mails need to be checked in the live environments
     */
