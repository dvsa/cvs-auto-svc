...
//    }
    ...
    public static String getToken() {
        ...
        // Temp code to get a token from a new source
        RestAssured.baseURI = "https://orpv6jv470.execute-api.eu-west-1.amazonaws.com/dev/1.0/nonprod/vta";
        RestAssured.requestSpecification = new RequestSpecBuilder().
                addHeader("x-api-key", loader.getTokenUrlApiKey())
                .build();

        Map<String, Object> map = new HashMap<>();
        map.put("username", loader.getMicrosoftOnlineUserNameVersion2());
        map.put("password", loader.getMicrosoftOnlinePassVersion2());
...
//
//        System.out.println("Trying to get a token");
//
