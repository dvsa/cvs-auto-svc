...
public class AwsUtil {
    ...
    public static String getNextTrailerIdInSequence() {
        ...
        String lastTrailerLetterUsed = GenericData.getValueFromJsonPath(dynamoInfo, "$.trailerLetter");
        if (lastTrailerSequenceNumberUsed != 0 && lastTrailerLetterUsed != null) {
            int nextTrailerNumberInSequence = lastTrailerSequenceNumberUsed + 1;
            return lastTrailerLetterUsed + nextTrailerNumberInSequence;
        }
        else {
